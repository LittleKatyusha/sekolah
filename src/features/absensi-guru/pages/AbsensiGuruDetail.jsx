...
// Status Badge Component (same as in AbsensiGuruList)
        ...
        <div className="md:col-span-1">
          <Card>
            <div className="p-6 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-2">NIP: {absensi.guru?.nip || '-'}</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">{absensi.jam_masuk || '-'}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">{absensi.jam_keluar || '-'}</p>
                  </div>
                </div>
