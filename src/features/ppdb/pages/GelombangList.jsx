...
import { Plus, RefreshCw, Eye, Edit, Trash2, MoreVertical, ExternalLink } from 'lucide-react'
  ...
  return (
    <div className="relative">
      ...
      {isOpen && createPortal(
        ...
        >
          <div className="py-1">
            <PermissionGuard permission="ppdb.gelombang.view">
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <PermissionGuard permission="ppdb.gelombang.create">
