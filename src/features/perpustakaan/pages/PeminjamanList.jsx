...
import { Plus, RefreshCw, Eye, Edit, Trash2, MoreVertical, RotateCcw } from 'lucide-react'
...
const ActionsMenu = ({ data, onDetail, onEdit, onDelete, onKembalikan, detailPermission, editPermission, deletePermission }) => {
  ...
  const showKembalikanAction = showKembalikan && onKembalikan && hasPermission('peminjaman.edit')
  const hasVisibleActions = showDetail || showEdit || showKembalikanAction || showDelete
        ...
        return (
          <div className="h-full flex items-center justify-center">
            <ActionsMenu
              ...
              detailPermission="peminjaman.view"
              editPermission="peminjaman.edit"
              deletePermission="peminjaman.delete"
            />
          </div>
        )
      }
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <PermissionGuard permission="peminjaman.create">
