...
export const tugasSiswaService = {
   ...
   * @param {string} [data.jawaban] - Answer text (optional)
   * @param {string} [data.file_path] - Submitted file path (optional)
   * @param {string} [data.tanggal_kumpul] - Submission date (optional)
   * @param {string|number} [data.status_kumpl] - Collection status (optional)
   * @param {number} [data.nilai] - Grade/score (optional)
   * @param {string} [data.catatan] - Teacher notes (optional)
   * @returns {Promise<{data: any, error: any}>}
   */
  create: async (data) => {
    return await apiService.post(TUGAS_SISWA_BASE_URL, data)
  },
   ...
   */
  update: async (id, data) => {
    return await apiService.put(`${TUGAS_SISWA_BASE_URL}/${id}`, data)
  },
   ...
   * @param {Object} [params] - Optional query parameters
   * @param {string} [params.status_kumpl] - Filter by collection status
   * @returns {Promise<{data: any, error: any}>}
   */
   ...
   */
  nilai: async (id, data) => {
    return await apiService.post(`${TUGAS_SISWA_BASE_URL}/${id}/nilai`, data)
  },
  ...
  kumpulkan: async (siswaId, tugasId, data = {}) => {
    return await apiService.post(`${TUGAS_SISWA_BASE_URL}/siswa/${siswaId}/tugas/${tugasId}/kumpulkan`, data)
  },
}
