  ...
  return (
    <div className="relative">
      ...
      {isOpen && createPortal(
        ...
        >
          <div className="py-1">
            <PermissionGuard permission="semester.view">
              <button
...
const SemesterList = () => {
  ...
  const columnDefs = useMemo(() => [
    ...
    },
    {
      ...
      minWidth: 180,
      valueGetter: (params) => {
        const ta = params.data?.tahun_ajaran
        if (!ta) return '-'
        return ta.nama || ta.kode || '-'
      }
    },
    {
      field: 'tanggal_mulai',
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Semester</h1>
