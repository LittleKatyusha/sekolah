...
import { RefreshCw, Eye, Edit, Trash2, MoreVertical } from 'lucide-react'
    ...
    <div className="relative">
      ...
      {isOpen && createPortal(
        <div ref={menuRef} className="fixed w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-[10000]" style={{ top: `${position.top}px`, left: `${position.left}px` }}>
          <div className="py-1">
            <PermissionGuard permission="ujian-jawaban.view">
            ...
            <PermissionGuard permission="ujian-jawaban.update">
            ...
            <PermissionGuard permission="ujian-jawaban.delete">
