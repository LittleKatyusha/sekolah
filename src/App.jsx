...
const AbsensiSiswaRekapBulanan = lazy(() => import('./features/absensi-siswa/pages/AbsensiSiswaRekapBulanan'))
...
const PanduanPage = lazy(() => import('./features/panduan/pages/PanduanPage'))
        ...
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route element={<ProtectedRoute><RouteAccessGuard><MainLayout /></RouteAccessGuard></ProtectedRoute>}>
              ...
              <Route path="/absensi-siswa/rekap-bulanan" element={<AbsensiSiswaRekapBulanan />} />
              ...
              {/* Petunjuk Penggunaan / Panduan Aplikasi */}
              <Route path="/panduan" element={<PanduanPage />} />
              <Route path="/petunjuk-penggunaan" element={<Navigate to="/panduan" replace />} />
